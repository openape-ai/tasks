...
- You are trying to delete a plan you do not own on a team you do not own.

## 404 Not Found
The resource does not exist, or it is soft-deleted. For plans, check with
`ape-tasks list`; a plan that was deleted will not appear.
